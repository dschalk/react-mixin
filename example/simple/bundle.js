...
/***/ function(module, exports, __webpack_require__) {
	...
	var _immutable = __webpack_require__(158);

	var reactMixin = __webpack_require__(159);
	exports.Component_1 = Component_1;

	var count = 0;

	var Component_1 = (function (_React$Component) {
	  _inherits(Component_1, _React$Component);

	  function Component_1(props) {
	    var _this = this;

	    _classCallCheck(this, Component_1);

	    _get(Object.getPrototypeOf(Component_1.prototype), 'constructor', this).call(this, props);

	    this.setImmState = function (fn) {
	    ...
	    this.handleListen = function () {
	      ...
	      _this.setImmState(function (d) {
	        return d.update('value2', function (x) {
	          return 'EventEmitter.listen success. state.message: ' + message;
	        });
	      });
	    };
	    ...
	    this.componentDidMount = function () {
	      _this.setTimeout(function () {
	        _this.setImmState(function (d) {
	          return d.update('foo', function (x) {
	            return 'baz';
	          });
	        });
	      }, 4000);
	      var handle = _react2['default'].findDOMNode(_this);
	      console.log(handle);
	    };

	    this.addAddListener = function () {
	      var addCounter = document.getElementById('addCounter');
	    };

	    this.addMinusListener = function () {
	      var minusCounter = document.getElementById('minusCounter');
	    };

	    this.add = function () {
	      _this.setImmState(function (d) {
	        return d.update('count2', function (v) {
	          return v + 1;
	        });
	      });
	    };
	    ...
	    this.handleIncrementClick = function () {
	      _this.setImmState(function (d) {
	        return d.update('value', function (v) {
	          return v + 1;
	        });
	      });
	    };

	    this.handleNoChangeClick = function () {
	      _this.setImmState(function (d) {
	        return d.update('value', function (v) {
	          return v;
	        });
	    ...
	    this.handleClickMessage = function () {
	      var message = _this.state.message;
	      _this.setImmState(function (d) {
	        return d.update('name', function (x) {
	          return message;
	        });
	      });
	    };

	    this.handleEnterMessage = function (e) {
	      var message = _this.state.message;
	      if (e.keyCode == 13) {
	        _this.setImmState(function (d) {
	          return d.update('name', function (x) {
	    ...
	    this.render = function () {
	      ...
	      count = count += 1;
	      var foo = data.get('foo');
	      var value = data.get('value');
	      var value2 = data.get('value2');
	      var name = data.get('name');
	      var count2 = data.get('count2');
	      var message = _this.state.message;
	      var add = _this.add;
	      var subtract = _this.subtract;
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            count,
	            ' times (see console log).'
	          ),
	          _react2['default'].createElement(
	            'button',
	            { onClick: _this.handleIncrementClick },
	            'Count Up Event'
	          ),
	          _react2['default'].createElement(
	            'button',
	            { onClick: _this.handleNoChangeClick },
	            'Set Same Value Event'
	          )
	        ),
	        _react2['default'].createElement('input', { id: 'alpha', autoFocus: true, type: 'text', valueLink: _this.linkState('message'), onKeyDown: _this.handleEnterMessage }),
	        _react2['default'].createElement(
	          'button',
	          { onClick: _this.handleClickMessage },
	          ' Enter name. '
	        ),
	        'Name: ',
	        name
	...
	reactMixin(Component_1.prototype, __webpack_require__(162));
	reactMixin(Component_1.prototype, __webpack_require__(163));
	reactMixin(Component_1.prototype, __webpack_require__(164));
	reactMixin(Component_1.prototype, __webpack_require__(115));

	_react2['default'].render(_react2['default'].createElement(Component_1, null), document.getElementById('divSix'));
	// 'render()' does not get called.
...
/***/ function(module, exports) {
	...
	module.exports = {
	    ...
	    componentWillUnmount: function componentWillUnmount() {
	        Object.keys(this.__timers).forEach(function (id) {
	            clearTimeout(id);
	        });
	    }
	};
